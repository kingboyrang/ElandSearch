...
- (void)genieAnimationShow:(bool)showing withDuration:(NSTimeInterval)duration complete:(void (^)(void))finish{
...
{
    [self genieAnimationShow:showing withDuration:duration complete:nil];
}
@end
